...
var temp__4098__auto__ = cljs.core.deref.call(null,clojure.browser.repl.xpc_connection);
if(cljs.core.truth_(temp__4098__auto__))
{var conn = temp__4098__auto__;
...
}catch (e6647){if((e6647 instanceof Error))
{var e = e6647;
...
var temp__4098__auto__ = clojure.browser.net.xpc_connection.call(null);
if(cljs.core.truth_(temp__4098__auto__))
{var repl_connection = temp__4098__auto__;
